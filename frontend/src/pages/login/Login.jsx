  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen mx-auto px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-lg p-10 rounded-3xl shadow-2xl bg-gradient-to-br from-white/10 via-white/5 to-white/10 backdrop-blur-3xl border border-white/20 overflow-hidden">
        {/* Floating Elements */}
        <div className="absolute top-6 left-6 w-4 h-4 bg-indigo-400 rounded-full animate-bounce"></div>
        <div
          className="absolute top-12 right-8 w-3 h-3 bg-purple-400 rounded-full animate-bounce"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-8 left-12 w-3 h-3 bg-pink-400 rounded-full animate-bounce"
          style={{ animationDelay: "2s" }}
        ></div>
